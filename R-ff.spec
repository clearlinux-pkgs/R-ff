...
Source0  : https://cran.r-project.org/src/contrib/ff_2.2-13.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521166895
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library ff|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/ff/libs/symbols.rds
